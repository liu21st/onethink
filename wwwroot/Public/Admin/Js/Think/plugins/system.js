	...
	exec    : function() {
			...
			if(updir){
				...
				var $html = $(
						...
						'                   <div class="filebox">'+
						'                   <input id="teupload" name="teupload" size="1" onchange="checkTypes(\'form_img\',\''+this.uptype+'\');" class="upinput" type="file" hidefocus="true" />'+
	...
	exec    : function() {
		...
		if(updir){
			...
			var $html = $(
					...
					'                   <div class="filebox">'+
					'                   <input id="teupload" name="teupload" size="1" onchange="checkTypes(\'form_swf\',\''+this.uptype+'\');" class="upinput" type="file" hidefocus="true" />'+
					'                   <input id="tefiletype" name="tefiletype" type="hidden" value="*" />'+
					'                   <input id="temaxsize" name="temaxsize" type="hidden" value="0" />'+
					'                   <span class="upbtn">上传</span>'+
					'                   </div>'+
