(function ($) {
    ...
    $.TE = {
        ...
        defaults: {
            ...
            controls: "source,|,undo,redo,|,cut,copy,paste,pastetext,selectAll,blockquote,|,image,flash,table,hr,pagebreak,face,code,|,link,unlink,|,print,fullscreen,|,about,|,style,font,fontsize,|,fontcolor,backcolor,|,bold,italic,underline,strikethrough,unformat,|,leftalign,centeralign,rightalign,blockjustify,|,orderedlist,unorderedlist,indent,outdent,|,subscript,superscript",
...
$.TE.config( 'conf1', {
	'uploadURL':'/index.php/Upload/Test',
	'controls' : 'style,font,fontsize,|,bold,italic,underline,strikethrough,unformat,|,leftalign,centeralign,rightalign,blockjustify,|,flash',
	'width':400,
	'height':500,
	'resizeType':1
} );
