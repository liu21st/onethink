...
CREATE TABLE `think_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='插件表';
...
INSERT INTO `think_addons` VALUES ('61', 'SocialComment', '通用社交化评论', '集成了各种社交化评论插件，轻松集成到系统中。', '1', '{\"comment_type\":\"1\",\"comment_uid_youyan\":\"90040\",\"comment_short_name_duoshuo\":\"code-tech\",\"comment_form_pos_duoshuo\":\"buttom\",\"comment_data_list_duoshuo\":\"10\",\"comment_data_order_duoshuo\":\"asc\"}', 'thinkphp', '0.1', '1378950537');
INSERT INTO `think_addons` VALUES ('62', 'ReturnTop', '返回顶部', '回到顶部美化，随机或指定显示，100款样式，每天一种换，天天都用新样式', '1', '{\"random\":\"0\",\"current\":\"6\"}', 'thinkphp', '0.1', '1378975837');
INSERT INTO `think_addons` VALUES ('64', 'Attachment', '附件', '用于文档模型上传附件', '1', '{\"status\":\"1\"}', 'thinkphp', '0.1', '1378979865');
...
INSERT INTO `think_auth_category_access` VALUES ('1', '21');
...
INSERT INTO `think_category` VALUES ('10', 'template', '模板', '2', '0', '10', '', '', '', 'Article/lists_template', '', '', '2', '2', '0', '1', '1', '0', '', '', '', '1378368703', '1378980690', '1');
INSERT INTO `think_category` VALUES ('11', 'addons', '插件', '2', '0', '10', '', '', '', 'Article/lists_addons', '', '', '', '2', '0', '1', '1', '0', '', '', '', '1378368723', '1378368723', '1');
...
INSERT INTO `think_category` VALUES ('18', 'test', '测试分类', '1', '0', '10', '', '', '', '', '', '', '1', '2', '0', '1', '0', '0', '1', '2', '', '1378981042', '1379129439', '1');
INSERT INTO `think_category` VALUES ('19', 'test2', '测试2', '1', '0', '10', '', '', '', '', '', '', '1', '2', '0', '1', '0', '0', '', '', '', '1378981128', '1378981128', '1');
INSERT INTO `think_category` VALUES ('20', 'asdf', 'asdfasd', '17', '0', '10', '', '', '', '', '', '', '1', '2', '0', '1', '1', '0', '1', '2', '', '1379068925', '1379068925', '1');
INSERT INTO `think_category` VALUES ('21', 'sdfgsdf', 'sdfgsfd', '5', '0', '10', '', '', '', '', '', '', '1', '2', '0', '1', '1', '0', '1', '2', '', '1379070000', '1379070030', '1');
...
-- ----------------------------
INSERT INTO `think_channel` VALUES ('1', '0', '首页', 'Index/index', '0', '1378977760', '1379129430', '1');
...
INSERT INTO `think_config` VALUES ('4', 'WEB_SITE_CLOSE', '0', '关闭站点', '0', '1', '站点关闭后其他用户不能访问，管理员可以正常访问', '1378898976', '1379053644', '1');
...
INSERT INTO `think_config` VALUES ('13', 'COLOR_STYLE', '4', '后台色系', '0', 'default_sytle:默认\r\nblue_style:蓝色', '后台颜色风格', '1379122533', '1379122607', '1');
...
INSERT INTO `think_document` VALUES ('11', '1', 'asdfasdfafff', '撒旦发射点法', '6', '撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法撒旦发射点法', '0', '2', '2', '7', '0', '0', '1', '0', '0', '0', '0', '0', '1378364483', '1378871369', '1');
...
INSERT INTO `think_document` VALUES ('13', '1', 'aaaaaaa', '图说企业家：家电大鳄 张近东', '12', '福布斯中文版将2012中国年度商业人物的唯一殊荣授予了张近东，49岁的福布斯富豪榜常青树、苏宁集团创始人张近东眼下的处境，代表了中国经济经历从亢奋到常温转变后，一批曾经的明星企业家的命运写照：业务上的直线上升和社会地位上的众星捧月戛然而止', '0', '1', '2', '0', '0', '8', '0', '0', '0', '0', '0', '0', '1378718254', '1378985428', '1');
...
INSERT INTO `think_document` VALUES ('16', '1', 'eee', '移动服务端整体解决方案', '12', '为移动应用开发者提供稳定可依赖的后端云服务，包括存储、账号管理、社交分享、推送等以及相关的技术支持和服务', '0', '1', '1', '0', '0', '0', '0', '1379649300', '0', '0', '0', '0', '1378784150', '1379071452', '1');
...
INSERT INTO `think_document` VALUES ('44', '12', '', '话说今天是程序员节', '8', '程序员节，每年的第256天，平年的9月13日，闰年的9月12日。', '0', '1', '2', '6', '0', '0', '2', '1378866600', '0', '0', '0', '0', '1379043633', '1379126033', '1');
...
INSERT INTO `think_document_model` VALUES ('4', 'Atlas', '图集', '1377569866', '1378949480', '1');
...
INSERT INTO `think_document_model_article` VALUES ('13', '0', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 福布斯中文版将2012中国年度商业人物的唯一殊荣授予了张近东，49岁的福布斯富豪榜常青树、苏宁集团创始人张近东眼下的处境，代表了中国经济经历从亢奋到常温转变后，一批曾经的明星企业家的命运写照：业务上的直线上升和社会地位上的众星捧月戛然而止。</p>', '');
...
) ENGINE=MyISAM AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='文件表\r\n@author   麦当苗儿\r\n@version  2013-05-21';
...
INSERT INTO `think_member` VALUES ('1', '管理员', '0', '0000-00-00', '', '40', '244', '2130706433', '1371435498', '2130706433', '1379127110', '1');
...
-- ----------------------------
INSERT INTO `think_ucenter_member` VALUES ('1', 'administrator', '7a58d2d679476c86911cfa65882ae430', 'zuojiazi@vip.qq.com', '', '1378981217', '2130706433', '1379127110', '2130706433', '1378981217', '1');
